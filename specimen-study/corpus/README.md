# Figurestead Specimen Corpus v0.1

This package is a **design and renderer-evaluation corpus**, not a scientific dataset collection.

It contains **12 deterministic synthetic scenes** built around data structures Figurestead already supports:
...
- `generate_corpus.py` — standard-library regeneration of the frozen v0.1 payloads.
- `expected-checksums.json` — hashes for the generated scene/table files.

## Why all-synthetic in v0.1
